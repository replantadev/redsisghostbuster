...
class Replanta_Ghost_Orders_GitHub_Updater {
    ...
    /**
     * Obtener informacion del ultimo release de GitHub
     */
    ...
    /**
     * Obtener informacion del ultimo tag (fallback si no hay releases)
     */
    ...
    /**
     * Mostrar informacion del plugin en el modal de detalles
     */
    ...
    private function get_installation_instructions() {
        ...
        <ol>
            ...
            <li>Ve a <strong>Plugins - Anadir nuevo - Subir plugin</strong></li>
        ...
        <p>Para mas informacion, visita el <a href="https://github.com/' . $this->github_username . '/' . $this->github_repo . '" target="_blank">repositorio en GitHub</a>.</p>
        ';
    }

    /**
     * Despues de instalar la actualizacion
     */
    ...
    /**
     * Forzar verificacion de actualizaciones
     */
    ...
    /**
     * Anadir enlaces en la fila del plugin
     */
